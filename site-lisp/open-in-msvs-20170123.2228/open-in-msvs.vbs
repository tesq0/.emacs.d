...
If solution <> "nil" Then
	 ...
	 ' If current no open solution or the open solution is different than provided, then open the provided
	 ...
	 strSearchString = solution

	 solutionPath = _
								objRegEx.Replace(strSearchString, _
																 "\")

	 If dte.Solution.FullName <> solutionPath Then
